...
export default function Company() {
  return (
    <div className="flex bg-white border-[1px] border-gray-200 shadow-xl mb-7 py-2 flex-row flex-wrap justify-between xl:flex-row-center pl-3 xl:ml-0  mt-5 px-2 md:px-6 text-[20px]">
