...
export default function Tickets() {
  ...
  //     .then((res) => setAllTicket(res.data[0].tickets));
  // }
      ...
      <div className="w-full py-5 px-2">
        <div className="w-full flex flex-row items-start">
          <button
            ...
            className="px-4 py-3 mb-4 md:mb-0 bg-blue hover:text-blue border-2 hover:bg-white hover:border-blue vazir-bold text-white rounded-xl shadow-xl"
          >
            ارسال تیکت جدید
          </button>
        </div>
