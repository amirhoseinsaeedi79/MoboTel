  ...
  return (
    <div className="w-full pt-[95px] md:pt-28 lg:pt-6 pb-2">
      ...
      <div className="w-full flex flex-col-reverse md:flex-row-reverse justify-between  px-2.5 md:px-6 mt-6 ">
        ...
        {/* ================================================================ sort products */}
        <div className="w-full md:w-[23%] xl:w-[25%] mb-7 md:mb-0 md:h-[470px] bg-white ml-5 flex md:justify-center flex-row md:flex-col rounded-xl py-2 md:pt-4 md:sticky md:top-[90px] shadow-xl">
          <div className="px-2 md:px-3  vazir-bold  md:flex flex-row md:flex-col ">
            <span className="text-blue md:pt-3">نمایش بر اساس :</span>
            <div className="flex flex-row md:flex-col justify-around text-[13px] md:text-[15px]">
